...
int main(int argc, char *argv[])
{
    ...
    // Release builds: the server-side socket (QLocalServer::UserAccessOption,
    // compositor runs as root) only accepts root connections — that is the
    // real identity enforcement.  This client-side pkexec escalation is a
